...
func TestRandomizedGenState(t *testing.T) {
	...
	require.Equal(t, sdkmath.LegacyZeroDec(), distrGenesis.Params.BaseProposerReward)  //nolint:staticcheck
	require.Equal(t, sdkmath.LegacyZeroDec(), distrGenesis.Params.BonusProposerReward) //nolint:staticcheck
